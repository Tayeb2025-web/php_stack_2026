...
if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `player_info` (`name`, `team`, `country`, `image`)
              VALUES('$name', '$team', '$country', '$image')";
...
<body class="min-h-screen">
  ...
  <div class="container">
    <form class="form" action="add_player.php" method="post">
      ...
      <div class="inputdiv">
        <label>Team</label>
        <input class="input" type="text" placeholder="team" name="team">
      </div>
      ...
      <div class="buttons">
        <button class="btn add" name="submit" type="submit">Add</button>
